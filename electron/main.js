...
function createTray() {
  // Create simple 1x1 colored bitmap for system tray if icon missing
  const icon = nativeImage.createEmpty();
  tray = new Tray(icon);
  
  const contextMenu = Menu.buildFromTemplate([
    { label: '🍔 Foody Enterprise', enabled: false },
    { type: 'separator' },
  ...
  tray.setToolTip('Foody Enterprise Delivery Management');

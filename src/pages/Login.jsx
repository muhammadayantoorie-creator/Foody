...
export default function Login() {
  ...
  // Navigate once role is resolved after a successful login
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigation is handled in the useEffect above once role is available
    } catch (err) {
      justSignedIn.current = false;
      ...
      if (msg.toLowerCase().includes('invalid login credentials')) {
        ...
        msg = 'Please check your inbox and confirm your email before signing in.';
      }
      setError(msg);
    }
    setLoading(false);
    ...
    <div style={S.page}>
      ...
      <div style={S.leftPanel}>
        ...
        <div style={S.leftContent}>
          ...
          <p style={S.heroSub} className="animate-fade-up stagger-2">
            Order from hundreds of top restaurants with live tracking and lightning-fast delivery.
          </p>
      ...
      <div style={S.rightPanel}>
        <div style={S.formCard} className="animate-scale-in">
          ...
          <p style={S.formSub}>Sign in to your FoodDash account to continue</p>
          ...
          <form onSubmit={handleSubmit} style={S.form}>
            ...
            >
              {loading
                ? <><InlineSpinner size={18} color="var(--text-on-primary)" /> Signing in...</>
                : 'Sign In'}
            </button>
          </form>
...
const S = {
  ...
  trustIcon: { fontSize: '0.9rem' },
  trustText: { color: 'rgba(255,255,255,0.9)', fontSize: '0.82rem', fontWeight: 600 },
  floatingFoods: {
    display: 'flex',
    gap: '1rem',
    marginTop: '0.5rem',
